...
<nav class="fixed top-0 z-50 w-10/12 right-0 bg-green-500 font-kanit">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">

                <div class="flex ms-2 md:me-24 h-12">
                    <span class="self-center text-xl font-semi-bold sm:text-2xl whitespace-nowrapi text-white dark:text-white">
                        @yield('topic')
                    </span>
                </div>
            </div>
